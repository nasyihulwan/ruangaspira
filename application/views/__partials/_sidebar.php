            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li
                            class="sidebar-item  has-sub <?php if ($this->uri->segment(1) == 'aspirasi') echo 'active' ?>">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item ">
                                    <a href="<?= site_url() ?>aspirasi/vnv">Verifikasi & Validasi</a>
                                </li>
                                <?php } ?>
                                <li class="submenu-item ">
                                    <a href="<?= site_url() ?>aspirasi/proses">Proses Tidak Lanjut</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="<?= site_url() ?>aspirasi/selesai">Selesai</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="<?= site_url() ?>aspirasi/ditolak">Ditolak</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item <?php if ($this->uri->segment(1) == 'laporan') echo 'active' ?>">
